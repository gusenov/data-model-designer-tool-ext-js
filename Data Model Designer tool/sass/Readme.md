...
folder are mapped to the application's root namespace, 'Data_Model_Designer_tool'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Data_Model_Designer_tool' in the same way
as `"Data_Model_Designer_tool/sass/src"`.
